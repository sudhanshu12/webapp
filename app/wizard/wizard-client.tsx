...
export default function WizardClient() {
  ...
  const [form, setForm] = useState<FormData>({
    ...
    hero_subheading_color: '#94a3b8',
    hero_description_color: '#9ca3af',
    hero_reviews_text_color: '#1f2937',
    ...
    about_heading_color: '#000000',
    about_description_color: '#6b7280',
    ...
    about_page_hero_tagline_color: '#6b7280',
    about_page_hero_heading_color: '#ffffff',
    about_page_hero_bg_color: '#374151',
    ...
    // Service Areas Section (Home) Customization
    service_areas_bg_color: '#232834',
    service_areas_text_color: '#ffffff',
    service_areas_heading_color: '#ffffff',
    service_areas_card_bg: 'rgba(255,255,255,0.1)',
    // Location Page Description Customization
    ...
    reviews_heading_color: '#1f2937',
    reviews_subtitle_color: '#6b7280',
    reviews_bg_color: '#f8f9fa',
    reviews_card_bg: '#ffffff',
    ...
    faq_bg_color: '#ffffff',
    faq_padding: 80,
    faq_text_color: '#0f172a',
    faq_heading_color: '#232834',
    faq_description_color: '#6b7280',
    faq_box_color: '#374151',
    faq_question_color: '#ffffff',
    faq_answer_color: '#b0b0b0',
    ...
    <div className="bsg-admin">
        <div className="wrap">
          ...
          <div className="bsg-header-content">
            <h2 style={{color: form.heading_color || undefined}}>Business Site Generator</h2>
                    ...
                    <div style={{marginTop: '2rem', textAlign: 'center'}}>
                      ...
                      <div style={{
                        ...
                        <div style={{ fontSize: '16px', fontWeight: 'bold', marginBottom: '8px' }}>
                          💳 Your Credits: {credits.remainingCredits} / {credits.totalCredits}
                        </div>
