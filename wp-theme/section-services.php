                ...
                <?php if (!empty($services)): ?>
                    ...
                    <div class="service-card" style="display:inline-block;vertical-align:top;width:320px;min-width:320px;margin-right:24px;background-color: <?php echo esc_attr($settings['services_card_color'] ?? '#232834'); ?>; color: <?php echo esc_attr($settings['services_text_color'] ?? '#ffffff'); ?>; border-radius: <?php echo esc_attr($settings['services_card_radius'] ?? '12'); ?>px; box-shadow: 0 2px 8px rgba(0,0,0,0.04);padding:0;box-sizing:border-box;overflow:hidden;">
                        ...
                        <div style="padding: 0 1.2rem 1.2rem 1.2rem;">
                            <a href="<?php echo esc_url($service_page_id ? get_permalink($service_page_id) : home_url('/services/' . $slug . '/')); ?>" style="display:inline-block; background:none !important; color:<?php echo esc_attr($settings['button_primary_color'] ?? '#2ee6c5'); ?>; font-weight:600; padding:0; text-decoration:none; border:none; box-shadow:none; transition:all 0.3s ease;" onmouseover="this.style.color='<?php echo esc_attr($settings['button_hover_color'] ?? '#22d3aa'); ?>';" onmouseout="this.style.color='<?php echo esc_attr($settings['button_primary_color'] ?? '#2ee6c5'); ?>';">See More <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round" style="vertical-align:middle;margin-left:4px;"><line x1="5" y1="12" x2="19" y2="12"></line><polyline points="12 5 19 12 12 19"></polyline></svg></a>
                        </div>
                    </div>
                    <?php endforeach; ?>
                <?php else: ?>
