...
<main>
                ...
                <div class="about-content">
                    ...
                    <div style="color: #4b5563; font-size: 1.1rem; line-height: 1.7; margin-bottom: 2rem;">
                        ...
                        if (!empty($about_content)) {
                            ...
                            echo '<p>With over ' . ($settings['about_years'] ?? '15') . ' years of experience in the ' . strtolower($business['business_type'] ?? 'roofing') . ' industry, ' . $business_name . ' brings unparalleled expertise and quality service to the residents of ' . ($business['state'] ?? 'your area') . '. Our team is dedicated to delivering exceptional results that exceed your expectations.</p>';
                            echo '<p>At ' . $business_name . ', we understand the common challenges faced by property owners when it comes to maintaining and improving their properties. That\'s why we offer a range of ' . strtolower($business['business_type'] ?? 'roofing') . ' services tailored to meet your specific needs, ensuring your satisfaction with every project.</p>';
                        }
                        ?>
                    </div>
    ...
    <section class="service-areas-section" style="background: #1f2937; color: white; padding: 80px 0;">
        <div class="container" style="max-width: 1200px; margin: 0 auto; padding: 0 20px;">
            <div style="text-align: center; margin-bottom: 3rem;">
                <h2 style="color: white; font-size: 2.5rem; font-weight: 700; margin: 0 0 1rem 0;">Proudly Serving <?php echo esc_html($business['state'] ?? 'Your Area'); ?> And The Surrounding Areas</h2>
                <p style="color: #d1d5db; font-size: 1.2rem; margin: 0;">Proudly serving <?php echo esc_html($business['state'] ?? 'your area'); ?> and surrounding areas with professional <?php echo strtolower($business['business_type'] ?? 'services'); ?>. We're committed to delivering quality work wherever you are.</p>
            </div>
            ...
            <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 4rem; align-items: center;">
                <div>
                    ...
                    <div style="color: #e5e7eb; font-size: 1.1rem; line-height: 1.7;">
                        At <?php echo esc_html($business_name); ?> in <?php echo esc_html($business['state'] ?? 'your area'); ?>, we're dedicated to providing reliable, high-quality <?php echo strtolower($business['business_type'] ?? 'services'); ?> with integrity and care. From repairs to replacements, we ensure your property is in expert hands—on time, on budget, every time.
                    </div>
                </div>
