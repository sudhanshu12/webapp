...
<head>
    ...
    try {
        ...
        echo '<link rel="icon" type="image/svg+xml" href="' . esc_url($favicon_data_url) . '">' . "\n";
        echo '<link rel="icon" type="image/svg+xml" sizes="16x16" href="' . esc_url($favicon_data_url) . '">' . "\n";
        echo '<link rel="icon" type="image/svg+xml" sizes="32x32" href="' . esc_url($favicon_data_url) . '">' . "\n";
        echo '<link rel="icon" type="image/svg+xml" sizes="48x48" href="' . esc_url($favicon_data_url) . '">' . "\n";
        echo '<link rel="apple-touch-icon" href="' . esc_url($favicon_data_url) . '">' . "\n";
        ...
        echo '<link rel="icon" type="image/svg+xml" href="' . esc_url($fallback_url) . '">' . "\n";
    }
    ?>
    
    <!-- Debug: Add a simple favicon for testing -->
